...
import {IAggregatorValidator} from './interfaces/IAggregatorValidator.sol';
import {IERC677} from './interfaces/IERC677.sol';

import {Median} from './utils/Median.sol';
 ...
 */
contract FluxAggregator is IAggregator, Ownable {
    struct Round {
        int256 answer;
        uint64 startedAt;
        uint64 updatedAt;
    ...
    function validateAnswer(uint32 _roundId, int256 _newAnswer) private {
        IAggregatorValidator av = validator; // cache storage reads
